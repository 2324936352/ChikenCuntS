    ...
    public class AdminController : Controller
        {
            ...
            public async Task<IActionResult> EditRole(string id)
            {
                ...
                var model = new LPFW.ViewModels.MusicViewModel.EditRoleViewModel
                {
                    Id = role.Id,
                    RoleName = role.Name
                };
            ...
            [HttpPost]
            public async Task<IActionResult> EditRole(LPFW.ViewModels.MusicViewModel.EditRoleViewModel model)
            {
            ...
            public async Task<IActionResult> EditUsersInRole(string roleId)
            {
                ...
                var model = new List<LPFW.ViewModels.MusicViewModel.UserRoleViewModel>();

                foreach (var user in userManager.Users)
                {
                    var userRoleViewmodel = new LPFW.ViewModels.MusicViewModel.UserRoleViewModel
                    {
            ...
            [HttpPost]
            public async Task<IActionResult> EditUsersInRole(List<LPFW.ViewModels.MusicViewModel.UserRoleViewModel> model, string roleId)
            {
                var role = await roleManager.FindByIdAsync(roleId);
                if (role == null)
                {
