...
namespace LPFW.WebApplication.Areas.TeachingBusiness.Controllers
{
    ...
    public class CourseController : BasePaginationTemplateController<Course, CourseVM>
    {
        ...
        public CourseController(IViewModelService<Course, CourseVM> service) : base(service)
        {
            ModuleName = "在线课程基础数据管理";
            FunctionName = "课程定义维护";

            // 1. 设置视图路径
            IndexViewPath               = "../../Views/Course/IndexWithNavigatorAndModal";
            ListPartialViewPath         = "../../Views/Course/_PaginationCommonListWithModal";
        ...
        public override async Task<IActionResult> PaginateList(string listPageParaJson)
        {
            ...
            ViewData["ListItems"] = ListItems;
            ViewData["ModuleName"] = ModuleName;
            ViewData["FunctionName"] = typeVM.Name + ": 所有数据";
        ...
        public async Task<IActionResult> CreateOrEditCourseItem(Guid id, Guid courseId) 
        {
            ...
            return PartialView("../../Views/Course/_CourseItemCreateOrEdit", courseItemVM);
        }
        ...
        public async Task<IActionResult> SaveCourseItemContent(CourseItemContentVM boVM) 
        {
            ...
            return PartialView("../../Views/Course/_CourseContentEdit", boVM);
