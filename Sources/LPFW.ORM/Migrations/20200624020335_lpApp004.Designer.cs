...
namespace LPFW.ORM.Migrations
{
    ...
    [Migration("20200624020335_lpApp004")]
    partial class lpApp004
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LPFW.EntitiyModels.MusicEntity.Album", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LPFW.EntitiyModels.MusicEntity.MusicManagement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("GroundingTime")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LPFW.EntitiyModels.MusicEntity.Power", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LPFW.EntitiyModels.MusicEntity.UserInfo", b =>
                {
                    b.HasBaseType("LPFW.EntitiyModels.ApplicationCommon.RoleAndUser.ApplicationUser");

                    b.Property<string>("Login")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("Power1Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LPFW.EntitiyModels.MusicEntity.AlbumWithMusics", b =>
                {
                    b.HasOne("LPFW.EntitiyModels.MusicEntity.Album", "Album")
                        .WithMany()
                        .HasForeignKey("AlbumId");

                    b.HasOne("LPFW.EntitiyModels.MusicEntity.MusicTypeEntity", "Music")
                        .WithMany()
            ...
            modelBuilder.Entity("LPFW.EntitiyModels.MusicEntity.MusicManagement", b =>
                {
                    ...
                    b.HasOne("LPFW.EntitiyModels.MusicEntity.MusicEntity", "Music")
                        .WithMany()
                        .HasForeignKey("MusicId");
                });
            ...
            modelBuilder.Entity("LPFW.EntitiyModels.MusicEntity.UserInfo", b =>
                {
                    b.HasOne("LPFW.EntitiyModels.MusicEntity.Power", "Power1")
                        .WithMany()
                        .HasForeignKey("Power1Id");
                });
